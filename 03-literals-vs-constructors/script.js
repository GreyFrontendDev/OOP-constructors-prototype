...
console.log(strLit instanceof String); // false as it was not created from string
console.log(strObj instanceof String); // True as it was gotten from the new String()
